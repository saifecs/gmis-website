export const site = {
  ...
  shortDescription:
    "GREENMARK Integrated Services is a Saudi-based integrated landscaping, concrete, and outdoor works company delivering high-quality, sustainable environments aligned with Saudi Vision 2030.",
  cr: "7053403460",
  entityType: "Company Limited Liability – One Person",
  status: "Active",
  establishedKSA: "2026",
  email: "info@gmis.sa",
